  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        {/* Summary banner */}
        {!loading && (
          <div className={`rounded-2xl border ${overallCfg.borderColor} ${overallCfg.bgColor} p-5 mb-8 flex items-center justify-between`}>
            <div className="flex items-center gap-3">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          {(['operational', 'degraded', 'partial_outage', 'major_outage'] as const).map(s => {
            ...
            return (
              <div key={s} className={`flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full border ${c.borderColor} ${c.bgColor}`}>
