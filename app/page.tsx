...
const CORE_PROVIDERS   = ['aws', 'cloudflare', 'bandwidth', 'thread', 'connectwise', 'hatz', 'godaddy', 'networksolutions', '3cx', 'azure', 'teams', 'sharepoint', 'checkpoint', 'mimecast', 'smtp2go', 'm365health'];
